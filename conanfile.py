...
class SparseH5DataAccessPluginConan(ConanFile):
    """Class to package the SparseH5Access-Plugin using conan
    ...
    name = "SparseH5Access"
    description = "Access some dimensions of a sparse matrix"
    topics = ("manivault", "hdps", "plugin", "analysis", "data", "sparse")
    url = "https://github.com/ManiVaultStudio/SparseH5DataAccessPlugin"
    ...
    scm = {
        "type": "git",
        "subfolder": "hdps/SparseH5DataAccessPlugin",
        "url": "auto",
        "revision": "auto",
    }
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/SparseH5DataAccessPlugin")
        cmake.verbose = True
        return cmake
