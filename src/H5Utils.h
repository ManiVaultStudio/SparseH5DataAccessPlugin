...
private:
    std::optional<std::vector<float>*> lookupCache(Cache& cache, std::list<int>& order, int id);
    void saveToCache(Cache& cache, std::list<int>& order, int id, const std::vector<float>& data);
